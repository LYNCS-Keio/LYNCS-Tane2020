...
# binary
    ...
    # pi.serial_write(h1, [0xA5, 0x5A, 0x80, 0x08, 0x00, 0xA0, 0x13, 0x01, 0xFF, 0x12, 0x34, 0x56, 0x3D])
    ser.write([0xA5, 0x5A, 0x80, 0x08, 0x00, 0xA0, 0x13, 0x01, 0xFF, 0x12, 0x34, 0x56, 0x3D])
